"""
TikTok Profiles dataset.

TikTok user profiles with follower counts, bio, and engagement data.
...
class TikTokProfiles(BaseDataset):
    """
    TikTok Profiles dataset.
    ...
    Example:
        >>> profiles = client.datasets.tiktok_profiles
